...
출제 기준:
- 객관적으로 검증 가능한 공식 명칭, 사실, 개념, 사례만 사용하며 애매하거나 논란의 여지가 있는 내용은 제외한다.
- 최신의 신뢰할 수 있는 정보를 바탕으로 단순 암기형보다 이해형·사고형을 우선하여 출제해야 한다.
- 특정 소재와 주제의 반복을 피하고, 분야 전반을 균형 있게 반영해야 한다.
 `           },
            {
                role: "user",
                content: `
