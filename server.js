...
const SPELLING_DATA = [
    ...
    { id: "SPACING_DEPENDENT_NOUN_SU", category: "의존 명사", allowed: ["할 수 있다", "할 수가 있다", "볼 수 있다", "볼 수가 있다", "갈 수 있다", "갈 수가 있다", "먹을 수 있다", "먹을 수가 있다"], forbidden: ["할수있다", "볼수있다", "갈수있다", "먹을수있다"], questionType: "single_correct", explanation: "한글 맞춤법 제42항에 따라 '수'는 의존 명사이므로 앞말과 띄어 쓴다. 또한, 조사 '가'는 의존 명사 '수'와 붙여쓸 수 있다." },
    { id: "SPACING_DEPENDENT_NOUN_JI", category: "의존 명사", allowed: ["먹은 지 오래되었다", "먹은 지가 오래되었다", "떠난 지 삼 년이다", "떠난 지가 삼 년이다", "시작한 지 얼마 안 되었다", "시작한 지가 얼마 안 되었다", "헤어진 지 오래다", "헤어진 지가 오래다"], forbidden: ["먹은지 오래되었다", "떠난지 삼 년이다", "시작한지 얼마 안 되었다", "헤어진지 오래다", "헤어진지가 오래다"], questionType: "single_correct", explanation: "시간의 경과를 나타내는 '지'는 의존 명사이므로 한글 맞춤법 제42항에 따라 앞말과 띄어 쓴다. 또한, 조사 '가'는 의존 명사 '지'와 붙여쓸 수 있다." },
