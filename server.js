    ...
    contents: [
        {
            ...
            parts: [
                {
                    text: `
다양한 분야(문화예술, 환경, 과학, 역사, 디지털 리터러시, 인권 리터러시, 한글 맞춤법, 코딩, 안전 및 건강상식, 경제, 지리, 정치, 심리학 등)에서 중하급-중급 난이도의 상식 퀴즈 5개를 생성하세요.

**필수 규칙:**
1. **각 문제는 위 분야들 중 랜덤으로 5개를 중복 없게 위에 나열된 순서에 상관없이 선택하여 출제한다. 단, 이전 세트에서 이미 출제된 분야는 나머지 모든 분야가 출제될 때까지 다시 선택하지 않는다.** 
또한, 한 분야에서 같은 소재의 문제 출제를 지양하고 여러 다양한 소재를 활용하여 출제할 것. ex) 안전 및 건강 상식 분야에서 심폐소생술 뿐만 아니라 허리 건강, 재난 등의 다양한 소재를 쓸 것.
2. 한글 맞춤법 문제는 2026년 현행 국립국어원 표준 규정 준수 (띄어쓰기, 사이시옷, 외래어 표기법 등)
3. 보기는 정확히 4개
